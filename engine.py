...
def main():
    ...
    colors = {
        ...
        'dark_ground': libtcod.Color(96, 96, 96),
        'light_wall': libtcod.Color(128, 128, 128),
        'light_ground': libtcod.Color(160, 160, 160)
    }
    ...
    libtcod.console_init_root(screen_width, screen_height, 'Not The Hero', False, vsync=True)
    ...
    while not libtcod.console_is_window_closed():
        ...
        if move and game_state == GameStates.PLAYERS_TURN:
            ...
            for entity in entities:
                if entity.item and entity.x == player.x and entity.y == entity.y:
